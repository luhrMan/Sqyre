//! Blank action factories for the Add Action picker (Go `buildActionTemplates`).
...
/// Picker column order (Go `buildAddActionPickerContentWithTiles`).
...
mod tests {
    ...
    #[test]
    fn blank_move_matches_go_defaults() {
