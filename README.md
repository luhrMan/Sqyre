...
- **Data editor** — programs, items (with icon variants), masks, points, search areas, collections, atlases; Tools tab for Overlay buttons, ScreenCap, and PixelCheck (drag-relocate overlay buttons while the Overlay tab is open)
