...
// func (m *macro) saveTreeToYamlFile(filename string) error {
// 	if filename == "" {
// 		return fmt.Errorf("cannot save empty filename")
// 	}
// 	yamlData, err := yaml.Marshal(m.root)
// 	if err != nil {
...
// func (m *macro) loadTreeFromYamlFile(filename string) error {
// 	log.Printf("loadTreeFromYamlFile: attempting to read file %v", filename)
// 	yamlData, err := os.ReadFile(path + filename)
// 	if err != nil {
// 		return fmt.Errorf("error reading file: %v", err)
// 	}
// 	var result actions.ActionInterface
// 	//err = json.Unmarshal(yamlData, root)
// 	m.root.SubActions = []actions.ActionInterface{}
// 	result, err = UnmarshalYAML(yamlData)
...
// // // **** NEW ATTEMPT
// func UnmarshalYAML(data []byte) (actions.ActionInterface, error) {
...
// // func searchArea(rawMap map[string]interface{}) structs.SearchBox {
