...
//! transparent layer-shell pulse when available, else windowed xdg-shell
//! (`compositor_kick`; not fullscreen — Mutter ignores alpha there). Outline/grab
//! will also bind layer-shell when present.
