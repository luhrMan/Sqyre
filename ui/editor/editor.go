...
// AutoPic tab handlers (screen capture in editor_preview_desktop.go / editor_preview_js.go).
func (eu *EditorUi) onAutoPicSave() { editorOnAutoPicSave(eu) }

func (eu *EditorUi) UpdateAutoPicPreview(searchArea *models.SearchArea) {
	editorUpdateAutoPicPreview(eu, searchArea)
}
...
func (eu *EditorUi) UpdateSearchAreaPreview(searchArea *models.SearchArea) {
	editorUpdateSearchAreaPreview(eu, searchArea)
}
...
func (eu *EditorUi) UpdatePointPreview(point *models.Point) {
	editorUpdatePointPreview(eu, point)
}
...
func (eu *EditorUi) UpdateMaskPreview(programName, maskName string) {
	editorUpdateMaskPreview(eu, programName, maskName)
}
